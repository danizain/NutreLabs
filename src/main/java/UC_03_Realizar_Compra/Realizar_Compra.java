...
import PageObjects.ResumoPedidoPO;
...
public class Realizar_Compra{
	...
	public void RelizarCompras() {
		...
		ppo.AcessarCarrinho();
		cpo.ConfirmarCarrinho();
		rpo.ConfirmarAssinatura();
	}
